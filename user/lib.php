 ...
 * @return array
 */
function user_get_participants_sql($courseid, $groupid, $accesssince, $roleid, $search, $additionalwhere, $additionalparams) {
    global $DB;
 ...
 * @return int
 */
function user_get_total_participants($courseid, $groupid, $accesssince, $roleid, $search, $additionalwhere, $additionalparams) {
    global $DB;
 ...
 */
function user_get_participants($courseid, $groupid, $accesssince, $roleid, $search, $additionalwhere, $additionalparams, $sort,
        $limitfrom, $limitnum) {
    global $DB;
