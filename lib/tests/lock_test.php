...
class lock_testcase extends advanced_testcase {
    ...
    public function test_locks() {
        $locktypes = array(
            '\core\lock\upgrade' => new \core\lock\upgrade(),
            '\core\lock\file' => new \core\lock\file(),
            '\core\lock\db' => new \core\lock\db(),
            '\core\lock\memcache' => new \core\lock\memcache(),
            '\core\lock\broken' => new \core\lock\broken()
        );
