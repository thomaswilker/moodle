...
define([ 'core/mustache',
     ...
     * @method eqHelper
     * @private
     * @param {string} sectionText The text to render if true.
     * @param {function} helper Used to render the section text.
     * @param {array} args List of arguments
     * @return {string}
     */
    var eqHelper = function(sectionText, helper, args) {
        var arg1 = args.shift();
        var arg2 = args.shift();
     ...
     * @return {string}
     */
    var neqHelper = function(sectionText, helper, args) {
        var arg1 = args.shift();
        var arg2 = args.shift();
     ...
     * @return {string}
     */
    var ltHelper = function(sectionText, helper, args) {
        var arg1 = parseFloat(args.shift());
        var arg2 = parseFloat(args.shift());
     ...
     * @return {string}
     */
    var gtHelper = function(sectionText, helper, args) {
        var arg1 = parseFloat(args.shift());
        var arg2 = parseFloat(args.shift());
        if (isNaN(arg1) || isNaN(arg2)) {
            return '';
     ...
     * @return {string}
     */
    var lteHelper = function(sectionText, helper, args) {
        var arg1 = parseFloat(args.shift());
        var arg2 = parseFloat(args.shift());
        if (isNaN(arg1) || isNaN(arg2)) {
            return '';
     ...
     * @return {string}
     */
    var gteHelper = function(sectionText, helper, args) {
        var arg1 = parseFloat(args.shift());
        var arg2 = parseFloat(args.shift());
        if (isNaN(arg1) || isNaN(arg2)) {
            return '';
     ...
     * @return {string}
     */
    var andHelper = function(sectionText, helper, args) {
        var arg1 = args.shift();
        var arg2 = args.shift();
     ...
     * @return {string}
     */
    var orHelper = function(sectionText, helper, args) {
        var arg1 = args.shift();
        var arg2 = args.shift();
    ...
    var addHelpers = function(context, themeName) {
        ...
        context.eq = function() { return eqHelper; };
        context.neq = function() { return neqHelper; };
        context.lt = function() { return ltHelper; };
        context.gt = function() { return gtHelper; };
        context.lte = function() { return lteHelper; };
        context.gte = function() { return gteHelper; };
        context.and = function() { return andHelper; };
        context.or = function() { return orHelper; };
