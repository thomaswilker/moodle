...
define(['jquery', 'core/log', 'core/str', 'core/templates', 'core/notification'], function($, log, str, templates, notification) {
    ...
    var addNavigation = function(inputId, datalistId, downArrowId, selectedId, originalSelect) {
        var inputElement = $(document.getElementById(inputId));
        inputElement.on('keydown', function(e) {
            switch (e.keyCode) {
                case KEYS.DOWN:
                    var selected = $(document.getElementById(selectedId));
                    selected.html('Hi some text for you');
    ...
    return /** @alias module:core/form-autocomplete */ {
        ...
        enhance: function(selector, tags, ajax, placeholder) {
            ...
            var selectedId = 'form-autocomplete-selected-' + $.now();
            ...
            var renderSelected = templates.render(
                'core/form-autocomplete-selected',
            ...
            $.when(renderSelected, renderInput, renderDatalist).done(function(selected, input, datalist) {
                originalSelect.after(datalist);
                originalSelect.after(input);
                originalSelect.after(selected);
                originalLabel.attr('for', inputId);
                addNavigation(inputId, datalistId, downArrowId, selectedId, originalSelect);
