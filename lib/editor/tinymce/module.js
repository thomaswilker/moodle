...
console.log('TinyMCE include module');
M.editor_tinymce.init_editor = function(Y, editorid, options) {

    console.log('TinyMCE init_editor');
    console.log('Add URL: ' + M.cfg.wwwroot + '/lib/editor/tinymce/all_strings.php?elanguage=' + options.language + '&rev=' + options.langrev);
