...
M.atto_image = M.atto_image || {
    ...
    init: function(params) {
        var display_chooser = function(e, elementid) {
            ...
            if (M.atto_image.selection !== false) {
                ...
                // Focus on the button by default when closing the dialogue.
                dialogue.set('focusAfterHide', M.editor_atto._buttons.image);
    ...
    filepicker_callback: function(params) {
        if (params.url !== '') {
            ...
            image.onload = function() {
                ...
                M.atto_image.dialogue.centerDialogue();
            };
    ...
    set_image: function(e, elementid) {
        ...
        // Don't auto-focus on the button that opened this dialogue.
        M.atto_image.dialogue.set('focusAfterHide', null);
    ...
    get_form_content: function(elementid) {
        ...
        html += '<label for="' + CSS.IMAGEPREVIEW + '">' + str.preview + '</label>' +
                '<div class="mdl-align">' +
                '<img src="#" id="' + CSS.IMAGEPREVIEW + '" alt="" style="display: none;"/>' +
                '</div>' +
                '<div class="mdl-align">' +
                '<br/>';
