...
var COMPONENTNAME = 'atto_image',
    ...
    TEMPLATE = '' +
            '<form class="atto_form">' +
                ...
                '<input type="checkbox" id="{{elementid}}_{{CSS.IMAGEPRESENTATION}}"/>' +
                '<label class="sameline {{CSS.IMAGEPRESENTATION}}" for="{{elementid}}_{{CSS.IMAGEPRESENTATION}}">{{get_string "presentation" component}}</label>' +
                '<br/>' +
...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
     ...
     * @return {String} The content to place in the dialogue.
     * @private
     */
