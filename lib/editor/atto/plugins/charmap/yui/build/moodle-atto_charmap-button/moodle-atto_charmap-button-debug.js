...
M.atto_charmap = M.atto_charmap || {
    ...
    init: function(params) {
        ...
        var display_chooser = function(e, elementid) {
            ...
            // Focus on the charmap button by default.
            dialogue.set('focusAfterHide', M.editor_atto._buttons.charmap);
    ...
    insertChar: function(e) {
        ...
        // We are inserting a character successfully, so don't let the editor auto-focus.
        M.atto_charmap.dialogue.set('focusAfterHide', null);
