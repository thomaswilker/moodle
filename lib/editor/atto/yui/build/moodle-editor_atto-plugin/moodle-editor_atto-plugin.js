...
Y.extend(EditorPlugin, Y.Base, {
     ...
     *
     * This is a convenience function and passes through to {{#crossLink "M.editor_atto.Editor/updateOriginal"}}updateOriginal{{/crossLink}}.
     *
     * @method markUpdated
     */
...
EditorPluginButtons.prototype = {
     ...
     * Possible states are:
     * <ul>
     * <li>{{#crossLink "M.editor_atto.EditorPlugin/ENABLED:property"}}{{/crossLink}}; and</li>
     * <li>{{#crossLink "M.editor_atto.EditorPlugin/DISABLED:property"}}{{/crossLink}}.</li>
     * </ul>
     *
     ...
     *
     * See {{#crossLink "M.editor_atto.Editor/selectionFilterMatches:method"}}{{/crossLink}} for more information.
     ...
     *
     * See {{#crossLink "M.editor_atto.EditorPlugin/addButton:method"}}addButton{{/crossLink}} for full details of the optional parameters.
     *
    ...
    _setButtonState: function(enable, button) {
        ...
        if (button) {
            if (this.buttons[button]) {
                ...
                this.buttons[button].setAttribute('aria-disabled', ariaDisabled);
            }
        } else {
    ...
    _changeButtonHighlight: function(highlight, button) {
        ...
        if (button) {
            if (this.buttons[button]) {
                ...
                this.buttons[button].setAttribute('aria-selected', ariaSelected);
            }
        } else {
