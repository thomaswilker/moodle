...
M.editor_atto = M.editor_atto || {
    ...
    init : function(params) {
        ...
        textarea.hide();
        atto.on('keydown', function() {
            this.save_selection(params.elementid);
        }, this);
        atto.on('mouseup', function() {
            this.save_selection(params.elementid);
        }, this);
        atto.on('focus', function() {
            this.restore_selection(params.elementid);
        }, this);
     ...
     */
    save_selection : function(elementid) {
     ...
     * @param string elementid
     */
    restore_selection : function(elementid) {
