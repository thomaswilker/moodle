...
class core_task {
     ...
     *
     * @return array(core_scheduledtask) - List of scheduled tasks for this component.
     */
     ...
     *
     * @param core_scheduledtask $task - The new scheduled task information to store.
     * @return boolean - True if the config was saved.
     */
    public static function configure_scheduled_task() {
        $cronlock = \core\lock\manager::get_current_lock_type();
     ...
     * @return array(core_scheduledtask)
     */
     ...
     * @return core_scheduledtask or null
     */
     ...
     *
     * @param core_scheduledtask
     */
    public static function scheduled_task_failed(core_scheduled_task $task) {
     ...
     * @param core_scheduledtask
     */
    public static function scheduled_task_complete(core_scheduled_task $task) {
        global $DB;
