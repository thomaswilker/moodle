...
function cron_execute_plugin_type($plugintype, $description = null) {
    global $DB;
    debugging('cron_execute_plugin_type() is deprecated, please use \core\task\scheduled_task instead.', DEBUG_DEVELOPER);
...
function cron_bc_hack_plugin_functions($plugintype, $plugins) {
    ...
    debugging('cron_bc_hack_plugin_functions() is deprecated, please use \core\task\scheduled_task instead.', DEBUG_DEVELOPER);
