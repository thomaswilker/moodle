...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2017022100.01) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017022100.01);
    }

    if ($oldversion < 2017022100.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017022100.02);
    }

    if ($oldversion < 2017022100.03) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017022100.03);
    }

    if ($oldversion < 2017022100.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017022100.04);
    }

    if ($oldversion < 2017022100.05) {

        \core\oauth2\api::install_default_issuers();
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2017022100.05);
    }
