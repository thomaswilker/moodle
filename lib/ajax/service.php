...
$ws = new webservice();
$validfunctions = $ws->get_external_functions_by_enabled_services(MOODLE_AJAX_SERVICE);

// Reformat the array so it is just a list of function names.
$getname = function($value) {
    return $value->name;
};
$validfunctions = array_map($getname, $validfunctions);
...
foreach ($requests as $request) {
    ...
    try {
        if (!in_array($methodname, $validfunctions)) {
