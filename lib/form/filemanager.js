    ...
    Y.extend(FileManagerHelper, Y.Base, {
            ...
            if (this.options.subdirs) {
                button_create.on('click',function(e) {
                    ...
                    if (!this.mkdir_dialog) {
                        ...
                        node.one('.fp-dlg-butcancel').setAttribute('id', 'fp-dlg-butcancel-'+this.client_id);
        ...
        show_confirm_dialog: function(dialog_options) {
            ...
            if (!this.confirm_dlg) {
                ...
                node.one('.fp-dlg-butconfirm').setAttribute('id', 'fp-dlg-butconfirm-'+node.get('id'));
        ...
        setup_select_file: function() {
            ...
            selectnode.one('.fp-file-update').setAttribute('id', 'fp-file-update-'+selectnode.get('id'));
            ...
            selectnode.one('.fp-file-download').setAttribute('id', 'fp-file-download-'+selectnode.get('id'));
            ...
            selectnode.one('.fp-file-delete').setAttribute('id', 'fp-file-delete-'+selectnode.get('id'));
            ...
            selectnode.one('.fp-file-zip').setAttribute('id', 'fp-file-zip-'+selectnode.get('id'));
            ...
            selectnode.one('.fp-file-unzip').setAttribute('id', 'fp-file-unzip-'+selectnode.get('id'));
            ...
            selectnode.one('.fp-file-cancel').setAttribute('id', 'fp-file-cancel-'+selectnode.get('id'));
