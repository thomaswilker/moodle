    ...
    Y.extend(ROLEPANEL, Y.Base, {
        ...
        initializer : function() {
            ...
            var element = Y.Node.create('<div class="popover popover-bottom"><div class="arrow"></div>' +
                                        ...
                                        '</div><div class="content popover-content"></div></div>');
            var content = element.one('.content');
            var roles = m.get(ASSIGNABLEROLES);
            for (i in roles) {
                var buttonid = 'add_assignable_role_' + roles[i].id;
                var buttonhtml = '<input class="btn btn-secondary p-r-1" type="button" value="' + roles[i].name + '" id="' + buttonid + '" />';
        ...
        display : function(user) {
            ...
            this.get('elementNode').removeClass('hide');
        ...
        hide : function() {
            ...
            this.roles = [];
            this.user = null;
            this.get('elementNode').addClass('hide');
            if (this.submitevent) {
