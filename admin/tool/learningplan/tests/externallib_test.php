 ...
 */
class tool_learningplang_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_competency_frameworks_with_read_permissions() {
        ...
        $result = external::create_competency_framework('shortname', 'idnumber', 'description', true);
    }
    ...
    public function test_create_competency_frameworks_with_nasty_data() {
        ...
        $result = external::create_competency_framework('short<a href="">', 'id;"number', 'de<>\\..scription', true);
    }
    ...
    public function test_update_competency_frameworks_with_manage_permissions() {
        ...
        $result = external::update_competency_framework($result->id, 'shortname2', 'description2', 'idnumber2', false);
    ...
    /**
     * Test we can list_and_count a competency framework with manage permissions.
     */
    public function test_list_and_count_competency_frameworks_with_manage_permissions() {
        $this->setUser($this->creator);
        $result = external::create_competency_framework('shortname', 'idnumber', 'description', true);
        $result = external::create_competency_framework('shortname2', 'idnumber2', 'description', true);
        $result = external::create_competency_framework('shortname3', 'idnumber3', 'description', true);
    ...
    /**
     * Test we can list_and_count a competency framework with read permissions.
     */
    ...
    public function test_reorder_competency_framework() {
        $this->setUser($this->creator);
        $f1 = external::create_competency_framework('shortname', 'idnumber', 'description', true);
        $f2 = external::create_competency_framework('shortname2', 'idnumber2', 'description', true);
        $f3 = external::create_competency_framework('shortname3', 'idnumber3', 'description', true);
        $f4 = external::create_competency_framework('shortname4', 'idnumber4', 'description', true);
        $f5 = external::create_competency_framework('shortname5', 'idnumber5', 'description', true);
        $f6 = external::create_competency_framework('shortname6', 'idnumber6', 'description', true);
