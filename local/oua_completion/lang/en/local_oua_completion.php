 ...
 *
 * @package local
 * @category oua_completion
 * @copyright 2013 onwards Russell Smith {@link http://moodle.com}
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'OUA Extended completion and progress';
$string['completionprogressoverrides'] = 'Overrides for default completion progress';
