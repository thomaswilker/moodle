...
class ouacompletionlib_testcase extends basic_testcase {
    ...
    /**
     * @covers local_oua_completion\\oua_completion_info::set_manual_state
     */
    function test_update_state() {
        $c = $this->getMock('local_oua_completion\\oua_completion_info', array('is_enabled','get_data','internal_get_state','internal_set_data'), array((object)array('id'=>42)));
    ...
    function test_internal_get_state() {
        ...
        $c = $this->getMock('local_oua_completion\\oua_completion_info', array('internal_get_grade_state'), array((object)array('id'=>42)));
    ...
    function test_set_module_viewed() {
        ...
        $c = $this->getMock('local_oua_completion\\oua_completion_info',
    ...
    function test_count_user_data() {
        ...
        $c = new \local_oua_completion\oua_completion_info($course);
    ...
    function test_delete_all_state() {
        ...
        // Session data has changed to MUC, so we don't track it.
    ...
    function test_reset_all_state() {
        ...
        $DB->expects($this->at(0))
            ...
            ->will($this->returnValue(
                new ouacompletion_test_fake_recordset(array((object)array('id'=>1, 'userid'=>100),(object)array('id'=>2, 'userid'=>101)))));
    ...
    function test_internal_set_data() {
        ...
        $this->markTestIncomplete('Fails in 2.9 without modification');

        $cm = (object)array('course' => 42,'id' => 13);
        $c = new \local_oua_completion\oua_completion_info((object)array('id' => 42));
    ...
    function test_get_progress_all() {
        ...
        $DB->expects($this->at(1))
            ...
            ->will($this->returnValue(new ouacompletion_test_fake_recordset(array($progress1, $progress2))));
...
*/
        ...
        $DB->expects($this->at(1))
            ->method('get_recordset_sql')
            ->will($this->returnValue(new ouacompletion_test_fake_recordset(array_slice($progress, 0, 1000))));
...
*/
        ...
        $DB->expects($this->at(3))
            ->method('get_recordset_sql')
            ->will($this->returnValue(new ouacompletion_test_fake_recordset(array_slice($progress, 1000))));
    ...
    function test_internal_get_grade_state() {
        ...
        $this->assertEquals(
            ...
            \local_oua_completion\oua_completion_info::internal_get_grade_state($item, $grade));
...
class ouacompletion_test_fake_recordset implements Iterator {
    var $closed;
    var $values, $index;
