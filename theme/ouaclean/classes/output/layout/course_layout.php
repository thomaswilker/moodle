 ...
 */
class course_layout extends base_layout implements renderable, templatable {
    /**
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pagelayout =
            $output->render_from_template('theme_ouaclean/layout_course', $data);

        $PAGE->requires->js_call_amd("theme_ouaclean/course_invisible", 'initialise');
        return $data;
    }
}
