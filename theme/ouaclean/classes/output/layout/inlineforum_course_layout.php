 ...
 */
class inlineforum_course_layout extends base_layout implements renderable, templatable {
    /**
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pagelayout =
            $output->render_from_template('theme_ouaclean/layout_inlineforum_course', $data);
