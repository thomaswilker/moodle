...
$string['helplocktype'] = 'Moodle is capable of using different methods of locking for subsystems such as cache and cron. The available lock types are:<br><ul><li>File locking - Suitable for single node installs on unix environments</li><li>PostgreSQL advisory locks - Suitable for clustered installs using PostgreSQL as a database.</li></ul>';
