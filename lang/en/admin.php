...
$string['helplocktype'] = 'Moodle is capable of using different methods of locking for subsystems such as cache and cron. Not all lock types are available for every Moodle installation. The full list of lock types are:<br><ul><li>File locking - Suitable for single node installs on unix environments</li><li>PostgreSQL advisory locks - Suitable for clustered installs using PostgreSQL as a database</li><li>MySQL locks - Suitable for clustered installs using MySQL as a database</li></ul>';
