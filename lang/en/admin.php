...
$string['locktype_filehelp'] = 'The file lock type use lock files stored in the dataroot. Whether this works on clusters depends on the file system used for the dataroot.';
$string['locktype_file'] = 'File Lock';
$string['locktype_dbhelp'] = 'The database lock type will use generic row based locking algorithm unless your database supports a more efficient native locking mechanism.';
