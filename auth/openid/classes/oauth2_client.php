...
class oauth2_client extends \oauth2_client {
    ...
    /**
     * Once we have an access token we can get the users profile info.
     * @return stdClass - Containing name, given_name, family_name, picture, email (and more).
     */
    public function get_user_info() {
        return json_decode($this->request($this->identityprovider->get('userinfoendpoint')));
    }
}
