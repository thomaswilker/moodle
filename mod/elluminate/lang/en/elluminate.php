...
// ******** Event Names ********
$string['eventloggedaudit'] = 'Logged audit';
// OUA Custom: add completion settings.
$string['customcompletionstate'] = 'Completion after start date';
$string['customcompletionstate_desc'] = 'Activity can only be completed after the session start date.';

$string['elluminate_delete_from_server'] = 'Delete elluminate sessions and recordings from server';
$string['elluminate_delete_from_server_desc'] = 'On activity deletion also remove recordings and sessions from elluminate servers.';
