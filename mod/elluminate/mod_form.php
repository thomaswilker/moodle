...
// OUA Custom: add completion settings.
   function add_completion_rules() {
      ...
      $mform->addElement('checkbox', 'customcompletionstate', get_string('customcompletionstate', 'elluminate'),
                         get_string('customcompletionstate_desc', 'elluminate'));

      return array('customcompletionstate');
   }

   function completion_rule_enabled($data) {
      return !empty($data['customcompletionstate']);
   }
   // End OUA Custom.
}
