...
// Had '$navigation = build_navigation($strelluminates);' here, but build_navigation() is deprecated.
// Using $PAGE->navbar methods instead.
if (is_array($strelluminates) && count($strelluminates)>0) {
	foreach ($strelluminates as $nav) {
...
$navigation = array('newnav' => true, 'navlinks' => array());
