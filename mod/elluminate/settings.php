...
if ($ADMIN->fulltree) {
 	// OUA CUSTOM:
	$settings->add(new admin_setting_configcheckbox('elluminate_delete_from_server', get_string('elluminate_delete_from_server', 'elluminate'),
												get_string('elluminate_delete_from_server_desc', 'elluminate'), false));
	// END OUA CUSTOM.
