...
class mod_assign_locallib_testcase extends advanced_testcase {
    ...
    public function test_display_grade() {
        $this->setUser($this->editingteachers[0]);
        ...
        $output = $assign->display_grade($data->grade, false, $this->students[0]->id);
        $this->assertEquals('50.00&nbsp;/&nbsp;100.00', $output);
    }
    ...
    public function test_count_submissions() {
        ...
        $this->assertEquals(4, $assign->count_submissions_with_status(ASSIGN_SUBMISSION_STATUS_DRAFT));
    }
