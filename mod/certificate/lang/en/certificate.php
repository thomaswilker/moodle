...
$string['datexy'] = 'Date Position X,Y';
$string['datexy_help'] = 'Comma separated x,y coordinates to print the date on the certificate e.g. 120,150 (-1 is centered horizontally e.g. -1,150';
$string['namexy'] = 'Students Name Position X,Y';
$string['namexy_help'] = 'Comma separated x,y coordinates to print the students name on the certificate e.g. 120,95 (-1 is centered horizontally e.g. -1,95';
...
$string['certificatebackgroundimage'] = 'Background image for certificate';
$string['certificatebackgroundimage_help'] = 'File to be used as certificate for this course.';
