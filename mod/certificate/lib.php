...
function certificate_add_instance($certificate) {
    ...
    $draftitemid = $certificate->certificatebackgroundimage;
    $context = context_module::instance($cmid);
    unset($certificate->certificatebackgroundimage);
    $certificateid = $DB->insert_record('certificate', $certificate);

    file_save_draft_area_files($draftitemid, $context->id, 'mod_certificate', 'certificatebackgroundimage', 0);
