...
class mod_certificate_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'namexy', get_string('namexy', 'mod_certificate'), array('size'=>'7', 'maxlength' => '255'));
        $mform->setType('namexy', PARAM_TEXT);
        $mform->setDefault('namexy', '-1,95');
        $mform->addHelpButton('namexy', 'namexy', 'mod_certificate');
        ...
        $mform->addElement('text', 'datexy', get_string('datexy', 'mod_certificate'), array('size'=>'7', 'maxlength' => '255'));
        $mform->setType('datexy', PARAM_TEXT);
        $mform->setDefault('datexy', '-1,150');
        $mform->addHelpButton('datexy', 'datexy', 'mod_certificate');
        ...
        $mform->addElement('filemanager', 'certificatebackgroundimage',
                           get_string('certificatebackgroundimage', 'mod_certificate'),
        ...
        $mform->setDefault('certificatetype', 'A4_embedded_background');
...
*/
    ...
    public function data_preprocessing(&$defaultvalues) {
        if ($this->current->instance) {
            $draftitemid = file_get_submitted_draft_itemid('certificatebackgroundimage');
            file_prepare_draft_area($draftitemid, $this->context->id, 'mod_certificate', 'certificatebackgroundimage', 0, $this->get_filemanager_options() );
            $defaultvalues['certificatebackgroundimage'] = $draftitemid;
        }
