...
class restore_brightcove_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_brightcove($data) {
        ...
        if($data->intro == null) {
            // Previous brightcove did not have an intro field, default to ''.
            $data->intro = '';
        }
        // insert the brightcove record
    ...
    protected function after_execute() {
        // Add brightcove related files, no need to match by itemname (just internally handled context)
        $this->add_related_files('mod_brightcove', 'videoid', null);
    }
}
