...
/**
 * Define the complete brightcove structure for backup, with file and id annotations
 */
class backup_brightcove_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $brightcove = new backup_nested_element('brightcove', array('id'), array(
            'name', 'playerid', 'videoid', 'intro', 'introformat', 'timemodified'));
        ...
        // Return the root element (brightcove), wrapped into standard activity structure
