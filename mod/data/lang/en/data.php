...
$string['navsearchresults'] = 'Navigate through the pages of search results';
...
$string['usetemplates'] = 'Customise database appearance with templates.';
$string['usetemplates_help'] = 'Database templates allow advanced users to have fine grained control of the display of each of the forms for adding, searching and displaying database entries. Enabling this setting will allow you to see and edit the html,css and javascript templates used by these forms.';
